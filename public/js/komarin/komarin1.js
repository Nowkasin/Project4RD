...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/Komarin/Komarin 1.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const documentId = '4ZP4aQmVWhIk36jU2UeQ'; // Replace with the Document ID you want to retrieve
