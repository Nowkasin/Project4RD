...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/Komarin/Komarin 2.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const collectionName = 'Komarin';
const documentId = 'IVwen6yU1VVL26KCZfzT'; // Replace with the Document ID you want to retrieve
