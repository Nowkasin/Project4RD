...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/skip/Skip 2.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const collectionName = 'skip';
const documentId = 'sLuQ4EClXUj7R8JV8imN'; // Replace with the Document ID you want to retrieve
