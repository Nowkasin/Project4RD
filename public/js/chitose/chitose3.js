...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/Chitose/Chitose 3.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const collectionName = 'Chitos';
const documentId = 'WlDL0SH622A8xdE4cK66'; // Replace with the Document ID you want to retrieve
