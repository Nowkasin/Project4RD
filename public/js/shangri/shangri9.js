...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/shangri/Shangri 9.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const documentId = 'aj5K47f1oAkmj42msW2n'; // Replace with the Document ID you want to retrieve
