...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/หมอยา/Kusuriya 3.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const collectionName = 'หมอยา';
const documentId = 'tM6OBkGmoQlFjvbG9XX7'; // Replace with the Document ID you want to retrieve
