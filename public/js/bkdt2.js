...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/oshi/Oshi 2.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const documentId = 'Z6MKkyr5gvZCw8xouY4O'; // Replace with the Document ID you want to retrieve
