...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/Sasayaku/Sasayaku 3.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const collectionName = 'Sasayaku';
const documentId = 'eH2T4XZgyDFg1lQbwxpv'; // Replace with the Document ID you want to retrieve
