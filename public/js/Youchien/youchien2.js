...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/Youchine/Youchien 2.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const collectionName = 'Youchien';
const documentId = '9pkAOmJQf8m6YckeomJG'; // Replace with the Document ID you want to retrieve
