...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/หมอยา/Kusuriya 5.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const documentId = 'qEprOgn71jbdCkhT0u9y'; // Replace with the Document ID you want to retrieve
