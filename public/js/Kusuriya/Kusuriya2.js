...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/หมอยา/Kusuriya 2.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const documentId = 'T1PLAW9BeCkwgeAVx4dp'; // Replace with the Document ID you want to retrieve
