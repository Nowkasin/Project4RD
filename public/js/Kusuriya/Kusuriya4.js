...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/หมอยา/Kusuriya 4.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const documentId = 'JWtcWNtTT5Aeyg251CDy'; // Replace with the Document ID you want to retrieve
