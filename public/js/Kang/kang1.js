...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/kang/Kage 1.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const collectionName = 'Kang';
const documentId = 'A4VnsV8205ozNbbA1hgs'; // Replace with the Document ID you want to retrieve
