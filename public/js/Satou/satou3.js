...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/Satou-san/Satou 3.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const collectionName = 'Satou-san';
const documentId = 'ebWpYZuxsGtPfyJ4bZl9'; // Replace with the Document ID you want to retrieve
