...
async function showData(data1) {
  ...
  const storageRef = ref(storage, 'gs://yarkarn-1c9ff.appspot.com/Satou-san/Satou 2.png'); // Replace 'imagePath' with the actual field name storing the image path in your Firestore document
...
const documentId = 'mMGfDJQf1a8S7MXlBjrM'; // Replace with the Document ID you want to retrieve
